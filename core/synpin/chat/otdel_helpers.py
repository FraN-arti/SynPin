...
ответе, что ты "создал/делегировал/отправил", если в этом же ответе
нет соответствующего tool-call (он будет показан как badge). Если
tool вернул ошибку — скажи про ошибку, а не придумывай успех.
