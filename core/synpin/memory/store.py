    ...
    def _render_block(self, target: str, entries: List[str]) -> str:
        ...
        if target == "user" and not entries:
            return (
                ...
                "════════════════════════════════════════════════\n"
                "USER PROFILE пуст. Познакомься с пользователем — "
                "представься коротко (1-2 предложения), спроси имя и роль. "
                "Не называй себя «ассистентом». Не более 3 предложений.\n"
                "После получения информации ЗАПОЛНИ USER.md через memory_write."
            )
