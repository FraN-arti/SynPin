...
class ProjectService:
    ...
    def get_project_head(self, project: Project) -> str | None:
        """
        Get the head agent of a project.
        
        Returns agent_id of the head of the main department.
        """
        main_dept = project.get_head_department()
        if not main_dept:
            return None
        
        # This will need to be connected to the department config
        # For now, return the department ID
        return main_dept.id
