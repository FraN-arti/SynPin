...
export const PROVIDER_CATALOG: ProviderInfo[] = [
  ...
  { id: 'opencode-free', name: 'OpenCode Free', key: 'opencode-free', iconFile: 'opencode', type: 'openai-compatible', category: 'free-tier', authMethod: 'no-auth', baseUrl: 'https://opencode.ai/zen/v1', defaultModels: [], apiKeyHint: 'не требуется' },
  ...
  { id: 'nvidia-nim', name: 'NVIDIA NIM', key: 'nvidia-nim', iconFile: 'nvidia', type: 'openai-compatible', category: 'free-tier', authMethod: 'apikey', baseUrl: 'https://integrate.api.nvidia.com/v1', defaultModels: ['meta/llama-3.3-70b-instruct', 'openai/gpt-oss-120b', 'qwen/qwen3.5-122b-a10b'], availableModels: ['meta/llama-3.3-70b-instruct', 'openai/gpt-oss-120b', 'openai/gpt-oss-20b', 'qwen/qwen3.5-122b-a10b', 'qwen/qwen3.5-397b-a17b', 'qwen/qwen3-next-80b-a3b-instruct', 'deepseek-ai/deepseek-v4-flash', 'deepseek-ai/deepseek-v4-pro', 'moonshotai/kimi-k2.6', 'minimaxai/minimax-m3', 'z-ai/glm-5.2', 'google/gemma-3-27b-it'], apiKeyHint: 'nvapi-...' },
  ...
  // ─── API Key Providers ────────────────────────────────────
  { id: 'anthropic', name: 'Anthropic', key: 'anthropic', iconFile: 'anthropic', type: 'anthropic', category: 'api-key', authMethod: 'apikey', baseUrl: 'https://api.anthropic.com', defaultModels: ['claude-sonnet-4-6', 'claude-opus-4-8', 'claude-haiku-4-5'], availableModels: ['claude-sonnet-4-6', 'claude-opus-4-8', 'claude-opus-4-7', 'claude-opus-4-6', 'claude-haiku-4-5-20251001', 'claude-sonnet-4-5', 'claude-haiku-4-5'], apiKeyHint: 'sk-ant-...' },
  { id: 'openai', name: 'OpenAI', key: 'openai', type: 'openai', category: 'api-key', authMethod: 'apikey', baseUrl: 'https://api.openai.com/v1', defaultModels: ['gpt-5', 'gpt-5-mini', 'gpt-4o'], availableModels: ['gpt-5', 'gpt-5-mini', 'gpt-4o', 'gpt-4o-mini', 'gpt-4o-realtime', 'gpt-audio', 'gpt-oss-120b', 'gpt-oss-20b'], apiKeyHint: 'sk-...' },
  { id: 'alibaba', name: 'Alibaba (Qwen)', key: 'alibaba', iconFile: 'qwen', type: 'openai-compatible', category: 'api-key', authMethod: 'apikey', baseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1', defaultModels: ['qwen3-max', 'qwen3.5-plus', 'qwen3.6-flash'], availableModels: ['qwen3-max', 'qwen3.7-max', 'qwen3.7-plus', 'qwen3.6-plus', 'qwen3.5-plus', 'qwen3.6-flash', 'qwen3.5-flash', 'qwen3-coder-plus', 'qwen3-coder-flash'], apiKeyHint: 'sk-...' },
  { id: 'alibaba-intl', name: 'Alibaba Intl', key: 'alibaba-intl', iconFile: 'qwen', type: 'openai-compatible', category: 'api-key', authMethod: 'apikey', baseUrl: 'https://dashscope-intl.aliyuncs.com/compatible-mode/v1', defaultModels: ['qwen3-max', 'qwen3.5-plus'], availableModels: ['qwen3-max', 'qwen3.7-plus', 'qwen3.6-plus', 'qwen3.5-plus', 'qwen3.6-flash'], apiKeyHint: 'sk-...' },
  { id: 'cerebras', name: 'Cerebras', key: 'cerebras', type: 'openai-compatible', category: 'api-key', authMethod: 'apikey', baseUrl: 'https://api.cerebras.ai/v1', defaultModels: ['gpt-oss-120b', 'zai-glm-4.7'], availableModels: ['gpt-oss-120b', 'zai-glm-4.7'], apiKeyHint: 'csk-...' },
  ...
  { id: 'deepseek', name: 'DeepSeek', key: 'deepseek', type: 'openai-compatible', category: 'api-key', authMethod: 'apikey', baseUrl: 'https://api.deepseek.com/v1', defaultModels: ['deepseek-chat', 'deepseek-reasoner'], availableModels: ['deepseek-chat', 'deepseek-reasoner', 'deepseek-v4-flash', 'deepseek-v4-pro'], apiKeyHint: 'sk-...' },
  { id: 'fireworks', name: 'Fireworks AI', key: 'fireworks', type: 'openai-compatible', category: 'api-key', authMethod: 'apikey', baseUrl: 'https://api.fireworks.ai/inference/v1', defaultModels: ['accounts/fireworks/models/llama-v3p3-70b-instruct', 'accounts/fireworks/models/deepseek-v3'], availableModels: ['accounts/fireworks/models/llama-v3p3-70b-instruct', 'accounts/fireworks/models/deepseek-v3', 'accounts/fireworks/models/qwen2p5-72b-instruct'], apiKeyHint: 'fw-...' },
  { id: 'glm-china', name: 'GLM (China)', key: 'glm-china', iconFile: 'glm', type: 'openai-compatible', category: 'api-key', authMethod: 'apikey', baseUrl: 'https://open.bigmodel.cn/api/paas/v4', defaultModels: ['glm-4.7', 'glm-4.5-air', 'glm-4-flash'], availableModels: ['glm-4.7', 'glm-4.7-flash', 'glm-4.5-air', 'glm-4.5-airx', 'glm-4-long', 'glm-4-flash-250414', 'glm-4-air-250414', 'glm-5', 'glm-5.1', 'glm-5.2'], apiKeyHint: 'API key' },
  { id: 'glm-coding', name: 'GLM Coding', key: 'glm-coding', iconFile: 'glm', type: 'openai-compatible', category: 'api-key', authMethod: 'apikey', baseUrl: 'https://open.bigmodel.cn/api/paas/v4', defaultModels: ['glm-4.7-code', 'codegeex-4-250414'], availableModels: ['glm-4.7-code', 'glm-4.5-code', 'codegeex-4-250414'], apiKeyHint: 'API key' },
  { id: 'groq', name: 'Groq', key: 'groq', type: 'openai-compatible', category: 'api-key', authMethod: 'apikey', baseUrl: 'https://api.groq.com/openai/v1', defaultModels: ['llama-3.3-70b-versatile', 'llama-3.1-8b-instant', 'qwen/qwen3-32b'], availableModels: ['llama-3.3-70b-versatile', 'llama-3.1-8b-instant', 'llama-3.1-70b-versatile', 'qwen/qwen3-32b', 'gemma2-9b-it', 'mixtral-8x7b-32768'], apiKeyHint: 'gsk_...' },
  ...
  { id: 'kimi', name: 'Kimi (Moonshot)', key: 'kimi', iconFile: 'kimi', type: 'openai-compatible', category: 'api-key', authMethod: 'apikey', baseUrl: 'https://api.moonshot.ai/v1', defaultModels: ['kimi-k2.5', 'kimi-k2.7'], availableModels: ['kimi-k2.7', 'kimi-k2.7-code', 'kimi-k2.7-code-highspeed', 'kimi-k2.6', 'kimi-k2.5', 'moonshot-v1-8k', 'moonshot-v1-32k', 'moonshot-v1-128k', 'moonshot-v1-8k-vision', 'moonshot-v1-32k-vision', 'moonshot-v1-128k-vision'], apiKeyHint: 'sk-...' },
  { id: 'minimax', name: 'MiniMax', key: 'minimax', iconFile: 'minimax', type: 'openai-compatible', category: 'api-key', authMethod: 'apikey', baseUrl: 'https://api.minimax.io/v1', defaultModels: ['MiniMax-M3', 'MiniMax-M2.5'], availableModels: ['MiniMax-M3', 'MiniMax-M2.7', 'MiniMax-M2.7-highspeed', 'MiniMax-M2.5', 'MiniMax-M2.5-highspeed', 'MiniMax-M2.1', 'MiniMax-M2.1-highspeed', 'MiniMax-M2'], apiKeyHint: 'API key' },
  { id: 'minimax-coding', name: 'MiniMax Coding', key: 'minimax-coding', iconFile: 'minimax', type: 'openai-compatible', category: 'api-key', authMethod: 'apikey', baseUrl: 'https://api.minimax.io/v1', defaultModels: ['MiniMax-M3'], availableModels: ['MiniMax-M3', 'MiniMax-M2.7-highspeed', 'MiniMax-M2.5-highspeed'], apiKeyHint: 'API key' },
  { id: 'mistral', name: 'Mistral', key: 'mistral', type: 'openai-compatible', category: 'api-key', authMethod: 'apikey', baseUrl: 'https://api.mistral.ai/v1', defaultModels: ['mistral-medium-2508', 'mistral-small-2506', 'codestral-2501'], availableModels: ['mistral-medium-2508', 'mistral-small-2506', 'mistral-large-2407', 'codestral-2501', 'ministral-3b-2410', 'ministral-8b-2410', 'pixtral-12b-2409'], apiKeyHint: 'API key' },
  { id: 'nebius', name: 'Nebius AI', key: 'nebius', type: 'openai-compatible', category: 'api-key', authMethod: 'apikey', baseUrl: 'https://api.studio.nebius.ai/v1', defaultModels: ['meta-llama/Llama-3.3-70B-Instruct', 'meta-llama/Meta-Llama-3.1-405B-Instruct'], availableModels: ['meta-llama/Meta-Llama-3.1-405B-Instruct', 'meta-llama/Llama-3.3-70B-Instruct', 'mistralai/Mistral-Large-Instruct-2407', 'Qwen/Qwen2.5-72B-Instruct'], apiKeyHint: 'API key' },
  ...
  { id: 'volcengine', name: 'Volcengine Ark', key: 'volcengine', iconFile: 'byteplus', type: 'openai-compatible', category: 'api-key', authMethod: 'apikey', baseUrl: 'https://ark.cn-beijing.volces.com/api/v3', defaultModels: ['doubao-seed-2.0-pro', 'doubao-seed-2.0-code'], availableModels: ['doubao-seed-2.0-pro', 'doubao-seed-2.0-lite', 'doubao-seed-2.0-code', 'doubao-seed-2.0-mini'], apiKeyHint: 'API key' },
  { id: 'xiaomi-mimo', name: 'Xiaomi MiMo', key: 'xiaomi-mimo', iconFile: 'xiaomi-mimo', type: 'openai-compatible', category: 'api-key', authMethod: 'apikey', baseUrl: 'https://api.xiaomimimo.com/v1', defaultModels: ['mimo-v2.5', 'mimo-v2.5-pro'], availableModels: ['mimo-v2.5', 'mimo-v2.5-pro', 'mimo-v2.5-asr', 'mimo-v2.5-tts', 'mimo-v2.5-tts-voiceclone', 'mimo-v2.5-tts-voicedesign'], apiKeyHint: 'API key' },
  ...
  { id: 'chutes', name: 'Chutes AI', key: 'chutes', type: 'openai-compatible', category: 'api-key', authMethod: 'apikey', baseUrl: 'https://llm.chutes.ai/v1', defaultModels: ['Qwen/Qwen3-32B-TEE', 'zai-org/GLM-5.1-TEE'], availableModels: ['Qwen/Qwen3-32B-TEE', 'Qwen/Qwen3.6-27B-TEE', 'google/gemma-4-31B-turbo-TEE', 'zai-org/GLM-5.1-TEE', 'deepseek-ai/DeepSeek-V3.2-TEE'], apiKeyHint: 'API key' },
