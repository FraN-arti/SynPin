...
# Директивы (обязанности)
directives:
  - "Думай перед внедрением кода"
  - "Всегда проверяй auth middleware первым"
  - "Предлагай минимум 2 варианта решения"
  - "Записывай ошибки в память после каждой сессии"
...
user:
  ...
  prefers: ["схемы", "диаграммы", "код"]
  dislikes: ["verbose логи", "длинные объяснения", "вода"]
  pet_peeves:
    - "Не задавай уточняющих вопросов — делай"
    - "Не пиши 'конечно!' — по делу"
    - "Не предлагай 5 вариантов — выбери лучший"

project:
  name: "SynPin"
  stack: ["Python/FastAPI", "React/Vite"]
  principles: ["локальный-first", "всё в Markdown"]
```
